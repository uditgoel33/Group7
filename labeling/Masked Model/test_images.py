...
model.load_weights('/content/drive/My Drive/logs/demo purpose20201104T2008/mask_rcnn_demo purpose_0002.h5', by_name=True, exclude=["mrcnn_class_logits", "mrcnn_bbox_fc","mrcnn_bbox", "mrcnn_mask"]) #if you run test this script on your local system you need to replace this path 
